...
<body>
    <div class="email-container">
        <div class="email-content">
            ...
            <p>We've detected activity on your account that requires your attention.</p>
            ...
            <p>Please review your recent activity and secure your account immediately.</p>

            <a href="{{ route('account.security') }}" class="email-button">Secure My Account</a>
