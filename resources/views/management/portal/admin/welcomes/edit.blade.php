        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <form action="{{ route('admin.welcomes.update', $welcome) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title', $welcome->title) }}" required
                            ...
                            <div>
                                ...
                                <input type="color" name="text_color" id="text_color" value="{{ old('text_color', $welcome->text_color ?? '#ffffff') }}"
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="body" id="body" rows="4" required
                                      class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:border-indigo-500 focus:ring-indigo-500">{{ old('body', $welcome->body) }}</textarea>
                            @error('body')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <input type="url" name="explore_link" id="explore_link" value="{{ old('explore_link', $welcome->explore_link) }}"
                                   class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:border-indigo-500 focus:ring-indigo-500">
                            @error('explore_link')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        @if($welcome->image)
                            <div class="mt-6">
                                ...
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $welcome->image) }}" alt="Current Image" class="w-32 h-32 object-cover rounded-lg">
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="mt-6">
                            <label for="image" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                {{ $welcome->image ? 'Replace Image' : 'Background Image' }}
                            </label>
                        ...
                        <div class="mt-6">
                            <div class="flex items-center">
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $welcome->is_active) ? 'checked' : '' }}
                        ...
                        <div class="flex justify-end mt-6 space-x-3">
                            <a href="{{ route('admin.welcomes.view', $welcome) }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300">
                                Cancel
                            </a>
