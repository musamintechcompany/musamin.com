<x-admin-layout title="Edit Coin Package">
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Edit Coin Package</h1>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.coin-packages.update', $coinPackage) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-8 pb-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="pack_name" id="pack_name" value="{{ old('pack_name', $coinPackage->pack_name) }}"
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <input type="color" name="badge_color" id="badge_color" value="{{ old('badge_color', $coinPackage->badge_color ?? '#3b82f6') }}"
                                   class="w-10 h-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 mr-3">
                            <input type="text" name="badge_color_hex" id="badge_color_hex" value="{{ old('badge_color', $coinPackage->badge_color ?? '#3b82f6') }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                   placeholder="#3b82f6">
                        </div>
            ...
            <div class="mb-8 pb-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="coins" id="coins" value="{{ old('coins', $coinPackage->coins) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <input type="number" name="bonus_coins" id="bonus_coins" value="{{ old('bonus_coins', $coinPackage->bonus_coins) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="price" id="price" value="{{ old('price', $coinPackage->price) }}"
            ...
            <div class="mb-8 pb-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="is_active" id="is_active" value="1"
                                   {{ old('is_active', $coinPackage->is_active) ? 'checked' : '' }}
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $coinPackage->sort_order) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div class="mb-8">
                ...
                <div x-data="{ features: {{ json_encode(old('features', $coinPackage->features ?? ['', ''])) }} }">
