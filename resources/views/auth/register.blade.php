                ...
                <div>
                    <label for="terms" class="flex items-start">
                        ...
                        <div class="text-sm text-gray-600 dark:text-gray-400">
                            I agree to the 
                            <a target="_blank" href="{{ route('terms.show') }}" class="text-sm underline text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">Terms of Service</a>
                            and 
                            <a target="_blank" href="{{ route('policy.show') }}" class="text-sm underline text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">Privacy Policy</a>
                        </div>
                    </label>
